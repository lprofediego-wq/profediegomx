// app/page.tsx — Landing Page (sin Supabase)
      ...
      <main className="relative overflow-hidden">
        ...
        <section className="relative min-h-[92vh] flex items-center bg-[#f8fafc] overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-24">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-50 border border-brand-100 rounded-full text-brand-700 text-[13px] font-semibold mb-8 animate-fade-in" style={{ animationDelay: '0ms' }}>
                <span className="w-2 h-2 bg-brand-500 rounded-full animate-pulse-slow" />
                Plataforma educativa #1 para exámenes de admisión
              </div>
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-slate-900 leading-[1.05] tracking-tight text-balance animate-slide-up" style={{ animationDelay: '80ms' }}>
                Prepárate y{' '}
              ...
              <p className="mt-8 text-xl text-slate-500 leading-relaxed max-w-xl animate-slide-up" style={{ animationDelay: '150ms' }}>
                Cursos especializados para IPN, UNAM, Cálculo y más. Aprende con el Profe Diego y consigue el lugar que mereces.
              </p>
              <div className="mt-10 flex flex-wrap gap-4 animate-slide-up" style={{ animationDelay: '220ms' }}>
                <Link href="/login" className="inline-flex items-center gap-2.5 px-7 py-3.5 bg-brand-600 hover:bg-brand-700 text-white rounded-2xl font-bold text-[15px] shadow-lg hover:shadow-blue-500/25 transition-all duration-200 active:scale-95">
              ...
              <div className="mt-10 flex items-center gap-3 animate-fade-in" style={{ animationDelay: '350ms' }}>
                <div className="flex -space-x-2">
                  {['CM', 'AV', 'LR', 'JP'].map((init, i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-brand-400 to-brand-600 border-2 border-white flex items-center justify-center text-white text-[10px] font-bold">{init}</div>
                  ))}
                </div>
                <p className="text-[13px] text-slate-500"><span className="font-bold text-slate-700">+2,400 alumnos</span> ya confían en Profe Diego</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="cursos" className="py-24 bg-[#f8fafc]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <p className="mt-3 text-slate-500 text-[16px] max-w-xl mx-auto">Contenido diseñado específicamente para los exámenes de admisión más exigentes de México.</p>
            </div>
        ...
        <section className="py-24 bg-brand-600 relative overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-blue-200 text-[16px] mb-8">Únete a miles de alumnos que ya aprobaron su examen con Profe Diego MX.</p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/login" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-brand-700 rounded-2xl font-bold hover:bg-blue-50 transition-all">
        ...
        <footer className="bg-slate-900 text-slate-400 py-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Image src="https://i.ibb.co/d4m853YQ/logo-sin-letras.png" alt="Profe Diego MX" width={32} height={32} className="object-contain opacity-90" />
